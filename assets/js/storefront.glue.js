...
const CART_KEY="mm_cart_horizon_static_v1";
const Cart = {
  items:[],
    ...
    el.innerHTML = `
      ...
      <div class="cart-drawer__meta">
        ...
        <div class="cart-drawer__qty">
          <button class="button" data-dec="${i.variantId}">−</button>
          <span class="qty-val">${i.quantity}</span>
          <button class="button" data-inc="${i.variantId}">+</button>
        </div>
      </div>
  ...
  if(info){
    info.innerHTML = `
      ...
      <div class="product__actions">
        <button class="button button--primary" id="buyNow">Adicionar ao carrinho</button>
      </div>
